		...
		{	
			...
			switch(list_type)
			{
			    ...
			    for(i=0;i<follow.length;i++){
				    ...
				    followList +='<em>同事<img class="small_icon down_arrow"></em>';           
				    followList +='</a>';
				    followList +='<div id="follow_group_1" class="cetdowme" style="position: absolute; z-index:1; display:none; ">';
				    followList +='<p class="hover"><input type="checkbox" class="labelbox" value="1"><label for="" title="同事">同事</label></p>';
				    followList +='<p><input type="checkbox" class="labelbox" value="1" id=""><label for="" title="朋友">朋友</label></p>';
