...
public class UserServImpl implements UserServ
{
	...
	{
		UserinfoDAO userDao = (UserinfoDAO) ImplUtil
				.getBeanByName("UserinfoDAO");
		Userinfo user = (Userinfo) userDao.findByProperty("login", login)
				.get(0);
		user.setLogin(login);
		return user;
	}
	...
	public boolean updateUser(Userinfo userinfo)
	{
		...
		try
		{
			UserinfoDAO userinfodao = (UserinfoDAO) ImplUtil
					.getBeanByName("UserinfoDAO");
	...
	public boolean compare(String oldpassword)
	{
		...
		// ImplUtil.getBeanByName("UserinfoDAO");
		Map<String, Object> session = ActionContext.getContext().getSession();
		Userinfo tmp = (Userinfo) session.get("user");
	...
	public ArrayList<Userinfo> getFamousList()
	{
		UserinfoDAO userDao = (UserinfoDAO) ImplUtil
				.getBeanByName("UserinfoDAO");
		FansManageDAO fmDao = (FansManageDAO) ImplUtil
				.getBeanByName("FansManageDAO");
		...
		ArrayList<FansManage> followList = (ArrayList<FansManage>) fmDao
				.findByFansId(userId);
	...
	public ArrayList<Userinfo> getNewconList()
	{
		UserinfoDAO userDao = (UserinfoDAO) ImplUtil
				.getBeanByName("UserinfoDAO");
		ArrayList<Userinfo> newcomList = (ArrayList<Userinfo>) userDao
				.findAll();
	...
	public ArrayList<Userinfo> getUserListByName(String nickName)
	{
		UserinfoDAO userDao = (UserinfoDAO) ImplUtil
				.getBeanByName("UserinfoDAO");
		ArrayList<Userinfo> results = (ArrayList<Userinfo>) userDao
				.fuzzySearchByNickName(nickName);
