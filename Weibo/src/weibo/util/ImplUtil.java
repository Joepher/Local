...
public class ImplUtil
{
	...
	public static ApplicationContext getApplicationContext()
	{
		...
		// return
		// WebApplicationContextUtils.getRequiredWebApplicationContext((ServletContext)request.getSession().getServletContext());
			...
			if (tmp[i].indexOf("]") > 0)
			{
				...
				switch (Emotion.getEmotion(emt))
				{
					case 奥特曼:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/otm.gif\" title=\"奥特曼\">");
						break;
					case 伤心:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/sad.gif\" title=\"伤心\">");
						break;
					case 围观:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/wg.gif\" title=\"围观\">");
						break;
					case 懒得理你:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/ldln.gif\" title=\"懒得理你\">");
						break;
					case 哈哈:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/laugh.gif\" title=\"哈哈\">");
						break;
					case 鄙视:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/bs.gif\" title=\"鄙视\">");
						break;
					case 花心:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/hs.gif\" title=\"花心\">");
						break;
					case 扣鼻屎:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/kbs.gif\" title=\"扣鼻屎\">");
						break;
					case 讨厌:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/hate.gif\" title=\"讨厌\">");
						break;
					case 给力:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/geili.gif\" title=\"给力\">");
						break;
					case 阴险:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/yx.gif\" title=\"阴险\">");
						break;
					case 嘿嘿:
						tmp[i] = tmp[i]
								.replace(emt + "]",
										"<img src=\"/Weibo/Images/emotions/hei.gif\" title=\"嘿嘿\">");
						break;
					default:
